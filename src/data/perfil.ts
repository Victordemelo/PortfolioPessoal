...
export const perfil = {
  ...
  sobre: [
    'Sou desenvolvedor de software em Florianópolis e estudo Engenharia da Computação na Unisul. Meu dia a dia é colocar sistema no ar: modelar o banco, escrever a API, montar a interface, containerizar e cuidar do deploy.',
